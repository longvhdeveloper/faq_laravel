                ...
                <div class="col-md-4 content signin_form">
                    <div class="panel panel-info">
                        <div class="panel-heading">
                            ...
                            <a href="{{URL::route('forgot_password')}}" class="pull-right" style="font-size: 78%;margin-top:-20px;">Forgot password ?</a>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                <span class="input-group-addon" id="username"><i class="fa fa-lock"></i></span>
                        ...
                        <div class="form-group">
                        {{Form::submit('Sign in', array('class' => 'btn btn-success pull-right'))}}
                        </div>
                        <div class="form-group expand-info-signin">
                            If you don't have account. Click
                            <a href="{{URL::route('signup')}}">here.</a> to register.
                        </div>
                        {{Form::close()}}
                        </div>
                    </div>
